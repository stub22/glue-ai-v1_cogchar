...
package org.cogchar.impl.channel {
	...
	class ThingActionChanSpec extends  org.cogchar.impl.chan.fancy.RealThingActionChanSpec {
		// This file was previously in a package that did not match the source folder name.
		// This class is a bridge to keep obsolete specs running for awhile.		
	}
	class ThingActionChanSpecBuilder(builderConfRes : Resource) extends org.cogchar.impl.chan.fancy.RealThingActionChanSpecBuilder(builderConfRes ) {
		// This file was previously in a package that did not match the source folder name.
		// This class is a bridge to keep obsolete specs running for awhile.
	}
}
