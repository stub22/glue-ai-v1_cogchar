...
// , PumaWebMapper webMapper, 	BundleContext bundleCtx) {
     ...
     * @param router
     *
     * This method embodies many of our brittle old assumption-scaffolding used
    ...
    /**
     * Called from PumaAppUtils.attachVWorldRenderModule, which is typically
     * called from a FrameworkStartedEvent.
     *
     * @param rModule
     */
