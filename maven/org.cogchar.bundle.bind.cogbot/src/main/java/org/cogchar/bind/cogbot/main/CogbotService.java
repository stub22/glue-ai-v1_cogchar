...
import static org.cogchar.bind.cogbot.main.CogbotConfigUtils.OLD_CONF_COBOT_BIN_DIR;
...
public class CogbotService {
	...
	private static final Logger theLogger = LoggerFactory.getLogger(CogbotService.class);
