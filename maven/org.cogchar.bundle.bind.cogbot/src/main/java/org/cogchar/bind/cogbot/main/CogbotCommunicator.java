...
import static org.cogchar.bind.cogbot.main.CogbotConfigUtils.OLD_CONF_FULL_NAME;
...
public class CogbotCommunicator { // implements INexusService {
	private static final Logger theLogger = LoggerFactory.getLogger(CogbotCommunicator.class);
