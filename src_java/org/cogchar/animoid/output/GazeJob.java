...
import org.cogchar.animoid.config.StereoGazeConfig;
...
public abstract class  GazeJob extends MotionJob {
	...
	public GazeJob(AnimoidConfig aconf) {
		super(aconf);
	}
	...
	@Override public Collection<Joint> getCautionJoints() {
        ...
        if (myCachedCautionJoints == null) {
            myCachedCautionJoints = getAnimoidConfig().getAllGazeBoundJoints();
        }
	...
	public JVFrame computeStereoGazePartnerVelFrame(Frame prevPosAbsRomFrame) {
		...
		StereoGazeConfig sgc = getAnimoidConfig().getStereoGazeConfig();
