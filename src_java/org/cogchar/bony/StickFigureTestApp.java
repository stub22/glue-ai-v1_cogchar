...
public class StickFigureTestApp extends SimpleApplication implements AnimEventListener {
	...
	public static void main(String[] args) {
		StickFigureTestApp owTst = new StickFigureTestApp();
...
// 		setupTextBox();
	...
	public void initWomanFaceModel() {
	  ...
	  /*
		...
		Node testSceneNode = (Node) assetManager.loadModel("leo_hanson_tests/test3/test3.scene");
