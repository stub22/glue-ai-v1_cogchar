...
/**
 *  From jme3test.bullet.BombControl by normenhansen.
 */
public class ExpodingProjectileControl extends RigidBodyControl implements PhysicsCollisionListener, PhysicsTickListener {
    ...
    public ExpodingProjectileControl(CollisionShape shape, float mass) {
        super(shape, mass);
        createGhostObject();
    }

    public ExpodingProjectileControl(AssetManager manager, CollisionShape shape, float mass) {
        super(shape, mass);
        createGhostObject();
