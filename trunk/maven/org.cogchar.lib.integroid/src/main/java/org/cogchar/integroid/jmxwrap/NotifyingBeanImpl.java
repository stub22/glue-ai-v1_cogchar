...
public class NotifyingBeanImpl extends NotificationBroadcasterSupport {
	private static final Logger theLogger = LoggerFactory.getLogger(NotifyingBeanImpl.class);
	...
	protected synchronized void sendAttributeChangeNotification(String message,
		...
		theLogger.debug("sendAttributeChangeNotification starting at " + currentTimeMillis);
		...
		theLogger.debug("sendAttributeChangeNotification finished at " + currentTimeMillis);
	}
