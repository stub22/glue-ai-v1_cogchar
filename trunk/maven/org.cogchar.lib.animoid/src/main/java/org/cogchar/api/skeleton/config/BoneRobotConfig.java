...
public class BoneRobotConfig extends KnownComponentImpl {
	...
	} // Needed by o.c.bind.rk.aniconv.ui
	...
	public BoneRobotConfig(RepoClient rc, Ident bonyConfigIdent, Ident graphIdent, BoneCN bqn) {
		...
		SolutionList bjPropSL = rc.queryIndirectForAllSolutions(bqn.BASE_BONE_JOINT_PROPERTIES_QUERY_QN, graphIdent, bqn.ROBOT_IDENT_QUERY_VAR, bonyConfigIdent);
	...
	public static class Builder extends DynamicCachingComponentAssembler<BoneRobotConfig> {
		...
		public void clearCacheForThisAssemblerType() {
			Debuggable.notImplemented("AssemblerUtils.clearCacheForAssemblerSubclassForSession(Builder.class, getSession());");
