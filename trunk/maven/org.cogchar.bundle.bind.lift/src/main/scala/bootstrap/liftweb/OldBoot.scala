...
class OldBoot_Ignored extends LifterLogger {
  ...
  def boot {
	...
	println("##################### bootstrap.liftweb.Boot.boot is running println")
	myLogger.error("%%%%%%%%%%%%%%%%%%%%%%% bootstrap.liftweb.Boot.boot - lifty shifty bubble gasp")
	...
	***********/
	...
	println("##################### bootstrap.liftweb.Boot.boot    2222222222222222")
	...
	println("##################### bootstrap.liftweb.Boot.boot    333333333333333333")
	...
	println("##################### bootstrap.liftweb.Boot.boot    444444444444444444")
	...
	println("##################### bootstrap.liftweb.Boot.boot   9999999999999999 ")
